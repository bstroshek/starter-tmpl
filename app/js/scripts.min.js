...
$(function(){$("form").submit(function(){var n=$(this);return $.ajax({type:"POST",url:"mail.php",data:n.serialize()}).done(function(){setTimeout(function(){n.trigger("reset")},1e3),setTimeout(function(){window.location.href="thanks.html"},2e3)}),!1}),$("[data-fancybox]").fancybox(),$("a").click(function(){var n=$(this).attr("href"),t=$(n).offset().top;return $("html, body").animate({scrollTop:t},1e3),!1})}),$(window).width()<=768&&$(document).ready(function(){var n=$("#my-menu").mmenu({offCanvas:{position:"left"},navbar:{title:"Меню"}}),t=$("#my-icon"),i=n.data("mmenu"),o=$(".mm-listview a");t.on("click",function(){i.open()}),o.on("click",function(){i.close()}),i.bind("open:finish",function(){setTimeout(function(){t.addClass("is-active")},100),$("body").css("padding-top","0")}),i.bind("close:finish",function(){setTimeout(function(){t.removeClass("is-active")},100)})});